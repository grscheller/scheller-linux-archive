...
### [Bash Notes](linux/notes/BashInfo.txt)
* My personal Bash Shell notes/cheatsheet

### [GIT Notes](linux/notes/GITnotes.txt)
...
### [Vim Notes](linux/notes/vimNotes/README.md)
...
### [Arch Linux Info](linux/notes/ArchLinuxInfo/)
* Contains Arch Linux specific information

### [CentOS 6 For the Unempowered](linux/notes/CentOS6Info/README.md)
* CentOS 6 without root privaledges
* Building GCC compiler chain and Haskell Stack in home directory

### [Windows 10 Powershell Configuration](linux/notes/Win10PowershellConfigFile)
