/** Package to test the fpinscala.rng package and 
 ...
 *
 */
package fpinscala.test.chap06.rng

import fpinscala.state.rng.{RNG, LCG}
import fpinscala.state.rng.RNG.{Rand,unit,sequence}
...
object RNGTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rollSome10 = sequence(diceRolls10)
    ...
    def averageDiceRoll(numRolls: Int): Rand[Double] = {
      val diceRolls = sequence(List.fill(numRolls)(twoDiceRoll))
