...
object initTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    print("twoDiceTrueProp(100, rng1): ")
    println(twoDiceTrueProp(100, rng1))
    print("twoDiceTrueProp(100, rng2): ")
    println(twoDiceTrueProp(100, rng2))
    print("twoDiceTrueProp(100, rng3): ")
    println(twoDiceTrueProp(100, rng3))
    print("twoDiceFalseProp(100, rng1): ")
    println(twoDiceFalseProp(100, rng1))
    print("twoDiceFalseProp(100, rng2): ")
    println(twoDiceFalseProp(100, rng2))
    print("twoDiceFalseProp(100, rng3): ")
    println(twoDiceFalseProp(100, rng3))
    ...
    print("procTrueAndTrue(100, rng1): ")
    println(procTrueAndTrue(100, rng1))
    print("procTrueAndTrue(100, rng2): ")
    println(procTrueAndTrue(100, rng2))
    print("procTrueAndTrue(100, rng3): ")
    println(procTrueAndTrue(100, rng3))
    print("procTrueOrTrue(100, rng1): ")
    println(procTrueOrTrue(100, rng1))
    print("procTrueOrTrue(100, rng2): ")
    println(procTrueOrTrue(100, rng2))
    print("procTrueOrTrue(100, rng3): ")
    println(procTrueOrTrue(100, rng3))

    print("procTrueAndFalse(100, rng1): ")
    println(procTrueAndFalse(100, rng1))
    print("procTrueAndFalse(100, rng2): ")
    println(procTrueAndFalse(100, rng2))
    print("procTrueAndFalse(100, rng3): ")
    println(procTrueAndFalse(100, rng3))
    print("procTrueOrFalse(100, rng1): ")
    println(procTrueOrFalse(100, rng1))
    print("procTrueOrFalse(100, rng2): ")
    println(procTrueOrFalse(100, rng2))
    print("procTrueOrFalse(100, rng3): ")
    println(procTrueOrFalse(100, rng3))

    print("procFalseAndTrue(100, rng1): ")
    println(procFalseAndTrue(100, rng1))
    print("procFalseAndTrue(100, rng2): ")
    println(procFalseAndTrue(100, rng2))
    print("procFalseAndTrue(100, rng3): ")
    println(procFalseAndTrue(100, rng3))
    print("procFalseOrTrue(100, rng1): ")
    println(procFalseOrTrue(100, rng1))
    print("procFalseOrTrue(100, rng2): ")
    println(procFalseOrTrue(100, rng2))
    print("procFalseOrTrue(100, rng3): ")
    println(procFalseOrTrue(100, rng3))

    print("procFalseAndFalse(100, rng1): ")
    println(procFalseAndFalse(100, rng1))
    print("procFalseAndFalse(100, rng2): ")
    println(procFalseAndFalse(100, rng2))
    print("procFalseAndFalse(100, rng3): ")
    println(procFalseAndFalse(100, rng3))
    print("procFalseOrFalse(100, rng1): ")
    println(procFalseOrFalse(100, rng1))
    print("procFalseOrFalse(100, rng2): ")
    println(procFalseOrFalse(100, rng2))
    print("procFalseOrFalse(100, rng3): ")
    println(procFalseOrFalse(100, rng3))
    ...
    print("exceptionalProp(10, rng1): ")
    println(exceptionalProp(10, rng1))
    print("exceptionalProp(50, rng1): ")
    println(exceptionalProp(50, rng1))
    print("exceptionalProp(100, rng1): ")
    println(exceptionalProp(100, rng1))
    ...
    print("failableExceptionalProp(10, rng3): ")
    println(failableExceptionalProp(10, rng3))
    print("failableExceptionalProp(10, rng1): ")
    println(failableExceptionalProp(10, rng1))
    print("failableExceptionalProp(20, rng1): ")
    println(failableExceptionalProp(20, rng1))
    print("failableExceptionalProp(10, rng2): ")
    println(failableExceptionalProp(10, rng2))
    print("failableExceptionalProp(20, rng2): ")
    println(failableExceptionalProp(20, rng2))
    ...
    print("procTrueOrExceptional(5, rng2): ")
    println(procTrueOrExceptional(5, rng2))
    print("procTrueOrExceptional(15, rng2): ")
    println(procTrueOrExceptional(15, rng2))

    print("procExceptionalOrTrue(5, rng2): ")
    println(procExceptionalOrTrue(5, rng2))
    print("procExceptionalOrTrue(15, rng2): ")
    println(procExceptionalOrTrue(15, rng2))

    print("procTrueAndExceptional(10, rng2): ")
    println(procTrueAndExceptional(10, rng2))
    print("procTrueAndExceptional(11, rng2): ")
    println(procTrueAndExceptional(11, rng2))
    print("procTrueAndExceptional(12, rng2): ")
    println(procTrueAndExceptional(12, rng2))

    print("procExceptionalAndTrue(5, rng2): ")
    println(procExceptionalAndTrue(5, rng2))
    print("procExceptionalAndTrue(15, rng2): ")
    println(procExceptionalAndTrue(15, rng2))

    print("procExceptionalOrFalse(15, rng2): ")
    println(procExceptionalOrFalse(15, rng2))
    print("procFalseOrExceptional(15, rng2): ")
    println(procFalseOrExceptional(15, rng2))
