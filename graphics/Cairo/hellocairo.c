/*
 *  Example Cairo Vector Graphics program
 *  slightly modified from the one on 
 *  the Cairo (graphics) Wikipedia Page:
...
int main(int argc, char **argv) {
    ...
    surface =
      (cairo_surface_t *)cairo_svg_surface_create("HelloCairo.svg", 100.0, 100.0);
