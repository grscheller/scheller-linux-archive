 ...
 *   7. Language is statement based, not expression based.
 ...
 *   8. Parser ignores whitespace other than to separate tokens.
 *   9. argv is a pointer to a pointer to a char.  Basically
